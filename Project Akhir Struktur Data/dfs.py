...
try:
    ...
    # Fungsi untuk mencari data berdasarkan nama produk menggunakan DFS
    def dfs_cari_laptop(data, nama_produk):
        stack = list(data.index)  # Inisialisasi stack dengan indeks dataframe
        visited = set()

        while stack:
            index = stack.pop()  # Ambil indeks terakhir dari stack
    ...
    dfs_cari_laptop(laptop_data, nama_produk)
